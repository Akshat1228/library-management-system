...
public class Home extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
        ...
        public Home() {
            ...
            ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("librarymanagementsystem/icon/second.png"));
            ...
            ImageIcon i4  = new ImageIcon(ClassLoader.getSystemResource("librarymanagementsystem/icon/third.png"));
            ...
            ImageIcon i7  = new ImageIcon(ClassLoader.getSystemResource("librarymanagementsystem/icon/fourth.png"));
	    ...
	    TitledBorder.TOP, null, new Color(220, 20, 60)));
            ...
            ImageIcon i10  = new ImageIcon(ClassLoader.getSystemResource("librarymanagementsystem/icon/fifth.png"));
            ...
            ImageIcon i13  = new ImageIcon(ClassLoader.getSystemResource("librarymanagementsystem/icon/sixth.png"));
            ...
            ImageIcon i16  = new ImageIcon(ClassLoader.getSystemResource("librarymanagementsystem/icon/seventh.png"));
